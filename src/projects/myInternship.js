...
export const myInternshipProject = {
  id: uuidv4(),
  title: 'MyInternship',
  description:
  ...
  liveSiteLink: 'https://myinternship.uk/',
  images: [
    {
      source:
    ...
    },
    {
      ...
      caption:
        'The app automatically assigns students to companies based on their respective priority lists',
    },
  ],
}
